...
library(badger)
cat(
	badge_cran_release("rFIA", "green"),
	badge_custom("Cite rFIA!", "in EMS", "yellow", "https://www.sciencedirect.com/science/article/abs/pii/S1364815219311089"),
	#badge_cran_download("rFIA", "grand-total", "blue"),
	badge_cran_download("rFIA", "last-month", "blue"),
	badge_travis("hunter-stanke/rFIA")
)
```

<!-- `r badge_custom("Cite rFIA!", "in EMS", "yellow", "https://www.sciencedirect.com/science/article/abs/pii/S1364815219311089")` -->
...
<!-- `r badge_cran_download("rFIA", "last-month", "green")` -->
